...
public class FileUtil {
    ...
    private static final String DATA_PATH = "C:\\Users\\NZP\\IdeaProjects\\Education\\src\\main\\java\\data";

    public static void serialazeLessons(List<Lesson> lessonList) {
    ...
    public static void serialazeStudents(List<Student> studentList) {
    ...
    public static void serialazeUser(Map<String, User> userMap) {
    ...
    public static List<Lesson> deserialazeLessons() {
    ...
    public static List<Student> deserialazeStudents() {
    ...
    public static Map<String, User> deserialazeUserMap() {
